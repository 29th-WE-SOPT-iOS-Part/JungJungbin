...
class RankingVC: UIViewController {
    ...
    func registerXib(){
        let xibName = UINib(nibName: RankTableViewCell.identifier, bundle: nil)
        rankTableView.register(xibName, forCellReuseIdentifier: RankTableViewCell.identifier)
    }
...
extension RankingVC: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: RankTableViewCell.identifier) as? RankTableViewCell else { return UITableViewCell()}
